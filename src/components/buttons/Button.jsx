const Button = ({
  ...
  const typeClasses = {
    primary: `bg-coral text-offwhite hover:bg-linear-to-b hover:from-coral hover:to-brightblue`,
    secondary: `bg-gray-300/25 text-offwhite hover:bg-gray-300/50`,
    tertiary: "bg-brightblue/25 text-offwhite hover:bg-brightblue/75",
